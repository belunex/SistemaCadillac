    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h1>Los datos se enviaron de manera correcta  de prueba.</h1>
            </div>
...
$(document).ready(function() {
    ...
    var tiempoEspera = 3000; // 10 segundos en milisegundos
    setTimeout(function() {
        $('#datosModal').modal('hide');
        setTimeout(function() {
            window.location.href = "<?php echo base_url() ?>index.php/administrador/usuarios";
        }, 300); // Esperar 500 milisegundos antes de redireccionar
    }, tiempoEspera);
});
</script>
