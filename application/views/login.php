...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="<?php echo base_url();?>/gentelella/assets/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled sidebar-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<a href="#" class="text-center pt-2">
							<img src="<?php echo base_url();?>/gentelella/production/images/iconCad.png" class="max-h-100px" alt="" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside body-->
				...
				<!--begin::Aside-->
				<!--begin::Content-->
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #7AB700;background: linear-gradient(to bottom, #7AB700, #00FF00); color: #FFFFFF;">
					<!--begin::Title-->
